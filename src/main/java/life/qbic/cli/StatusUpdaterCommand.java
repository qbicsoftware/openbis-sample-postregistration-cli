...
/**
 * Abstraction of command-line arguments that will be passed to {@link SampleUpdater} at construction time.
 */
@Command(
   name="OpenBIS status updater",
   description="Command-line utility to...")
public class StatusUpdaterCommand extends AbstractCommand {
    ...
    @Option(names={"-c", "--config"}, description ="Property file in JSON to run the sample status updater.", required=true)
    String config;
}